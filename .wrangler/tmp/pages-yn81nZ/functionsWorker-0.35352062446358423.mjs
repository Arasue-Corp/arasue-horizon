...
async function onRequest(context) {
  ...
  if (pathname.startsWith("/_next") || pathname.startsWith("/api") || pathname.startsWith("/workshop") || pathname.includes(".")) {
    return next();
  }
  const locales = ["es", "en"];
...
// ../.wrangler/tmp/pages-yn81nZ/functionsRoutes-0.6065787581760365.mjs
var routes = [
  {
    routePath: "/:path*",
    mountPath: "/",
...
// ../.wrangler/tmp/bundle-YP7Al5/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-YP7Al5/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.35352062446358423.mjs.map
