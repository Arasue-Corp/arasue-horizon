...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const title = (dict as any).labs.shop_page?.title || 'LabsShopPage'
  const description = (dict as any).labs.shop_page?.subtitle || 'Arasue Horizon'
...
export default async function LabsShopPage({
  params
}: {
  ...
  return (
    <div className="flex flex-col min-h-[80vh] pt-32 pb-24 px-6 font-serif text-[#1a2e1a]">
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          <img 
            src="https://placehold.co/1200x675/1a1a1a/ffffff?text=Labs+Shop+Image" 
            alt="Labs Shop" 
