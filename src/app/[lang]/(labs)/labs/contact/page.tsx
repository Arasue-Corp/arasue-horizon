...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const title = (dict as any).labs.contact_page?.title || 'LabsContactPage'
  const description = (dict as any).labs.contact_page?.subtitle || 'Arasue Horizon'
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          <div className="w-full relative aspect-video lg:aspect-square bg-foreground/5 rounded-3xl overflow-hidden border border-foreground/10">
            {/* Image Placeholder */}
            <img 
              src="https://placehold.co/800x800/1a1a1a/ffffff?text=Labs+Contact+Image" 
              alt="Labs Contact" 
