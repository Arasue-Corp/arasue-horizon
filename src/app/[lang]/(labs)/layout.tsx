...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    title: `Arasue Labs | ${(dict.labs as any)?.boutique?.hero?.title || 'Sonoran Desert Honey'}`,
    description: (dict.labs as any)?.boutique?.hero?.subtitle || 'Premium organic products, sustainably sourced and meticulously crafted.',
    ...
    openGraph: {
      title: 'Arasue Labs',
      description: (dict.labs as any)?.boutique?.hero?.subtitle,
