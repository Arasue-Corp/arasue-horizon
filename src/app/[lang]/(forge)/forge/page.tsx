    ...
    <div className="flex flex-col bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-24 px-6 overflow-hidden">
        ...
        >
          ...
          <p className="text-xl md:text-3xl text-foreground/60 max-w-2xl mt-8 font-light tracking-wide">
            {dict.forge.hero.subtitle}
          </p>
          <div className="pt-12 flex flex-col sm:flex-row gap-4">
            <Link href="#contact" className="px-10 py-5 rounded-full bg-primary text-primary-foreground font-bold text-lg hover:scale-105 active:scale-95 transition-all text-center">
              {dict.forge.hero.cta}
            </Link>
            <Link href="#work" className="px-10 py-5 rounded-full border border-foreground/20 font-bold text-lg hover:bg-foreground/10 active:scale-95 transition-all text-center">
      ...
      <section className="py-16 border-y border-foreground/5 bg-foreground/[0.02]">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm font-mono text-foreground/40 mb-8 uppercase tracking-widest">{dict.forge.ticker.trusted}</p>
      ...
      <section id="work" className="py-32 px-6">
        <div className="container mx-auto max-w-7xl">
          <div className="mb-20">
            ...
            <p className="text-xl text-foreground/60 max-w-2xl">{dict.forge.work.subtitle}</p>
          </div>
          ...
          <div className="space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 space-y-8">
                ...
                <p className="text-lg text-foreground/60 leading-relaxed">{dict.forge.work.project1_desc}</p>
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 rounded-full border border-foreground/10 text-sm">Next.js</span>
                  <span className="px-4 py-2 rounded-full border border-foreground/10 text-sm">PostgreSQL</span>
                  <span className="px-4 py-2 rounded-full border border-foreground/10 text-sm">Stripe API</span>
                </div>
              </div>
              <div className="order-1 lg:order-2">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-foreground/5 border border-foreground/10 relative p-8 group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-2 space-y-8">
                ...
                <p className="text-lg text-foreground/60 leading-relaxed">{dict.forge.work.project2_desc}</p>
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 rounded-full border border-foreground/10 text-sm">React Native</span>
                  <span className="px-4 py-2 rounded-full border border-foreground/10 text-sm">GraphQL</span>
                  <span className="px-4 py-2 rounded-full border border-foreground/10 text-sm">Shopify</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 4. Process Flow */}
      <section className="py-32 px-6 bg-foreground/[0.02] border-y border-foreground/5">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <div>
              ...
              <p className="text-xl text-foreground/60">{dict.forge.pricing.features}</p>
            </div>
            <div className="text-sm font-mono px-4 py-2 bg-foreground/5 rounded-full border border-foreground/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              <div key={service.id} className="bg-foreground/5 border border-foreground/10 p-8 rounded-3xl hover:bg-foreground/10 transition-colors flex flex-col group">
                <h3 className="text-2xl font-bold mb-3 group-hover:text-blue-400 transition-colors">{service.title}</h3>
                <p className="text-foreground/60 mb-8 flex-1 text-sm">{service.desc}</p>
                
                <div className="space-y-4 border-t border-foreground/10 pt-6">
                  {service.priceSetup && (
                    <div className="flex justify-between items-baseline">
                      <span className="text-xs font-mono text-foreground/40">{dict.forge.pricing.setup}</span>
                      <span className="text-xl font-bold">{currencySymbol}{service.priceSetup}</span>
                    </div>
                  )}
                  {service.priceMo && (
                    <div className="flex justify-between items-baseline">
                      <span className="text-xs font-mono text-foreground/40">{dict.forge.pricing.mo}</span>
                      <span className="text-xl font-bold text-blue-400">{currencySymbol}{service.priceMo}</span>
                    </div>
                  )}
                  {service.priceOneTime && (
                    <div className="flex justify-between items-baseline">
                      <span className="text-xs font-mono text-foreground/40">{dict.forge.pricing.one_time}</span>
                      <span className="text-xl font-bold">{currencySymbol}{service.priceOneTime}</span>
                    </div>
                  )}
                  {service.priceRetainer && (
                    <div className="flex justify-between items-baseline">
                      <span className="text-xs font-mono text-foreground/40">{dict.forge.pricing.retainer}</span>
      ...
      <section className="py-24 px-6 relative z-10 border-t border-foreground/5">
        <ForgeEstimator lang={resolvedParams.lang as 'en' | 'es'} />
      </section>

      {/* 5.6. FAQ */}
      <section className="py-24 px-6 relative z-10 border-t border-foreground/5 bg-foreground/[0.01]">
        <ForgeFAQ lang={resolvedParams.lang as 'en' | 'es'} />
      </section>

      {/* 6. Testimonials */}
      <section className="py-24 px-6 border-y border-foreground/5 bg-foreground/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div className="text-blue-400 text-4xl">"</div>
              <p className="text-2xl font-light leading-relaxed italic text-foreground/80">{dict.forge.testimonials.text1}</p>
              <div className="flex items-center gap-4 pt-4 border-t border-foreground/10">
                ...
                <div>
                  ...
                  <div className="text-sm text-foreground/40 font-mono">{dict.forge.testimonials.role1}</div>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="text-purple-400 text-4xl">"</div>
              <p className="text-2xl font-light leading-relaxed italic text-foreground/80">{dict.forge.testimonials.text2}</p>
              <div className="flex items-center gap-4 pt-4 border-t border-foreground/10">
                <div className="w-12 h-12 rounded-full bg-foreground/10" />
                <div>
                  <div className="font-bold">{dict.forge.testimonials.author2}</div>
                  <div className="text-sm text-foreground/40 font-mono">{dict.forge.testimonials.role2}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="contact" className="py-32 px-6 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-3xl space-y-8 relative z-10 bg-background/80 backdrop-blur-xl p-16 rounded-[3rem] border border-foreground/10 shadow-2xl">
          <h2 className="text-5xl md:text-7xl font-black tracking-tight">{dict.forge.cta.title}</h2>
          <p className="text-xl text-foreground/60 font-light">{dict.forge.cta.subtitle}</p>
          <div className="pt-8">
            <button className="px-10 py-5 rounded-full bg-primary text-primary-foreground font-bold text-xl hover:scale-105 active:scale-95 transition-all shadow-[0_0_40px_rgba(255,255,255,0.3)]">
              {dict.forge.hero.cta_contact}
            </button>
          </div>
          <p className="text-xs font-mono text-foreground/40 pt-4">{dict.forge.cta.note}</p>
        </div>
      </section>
    </div>
  )
