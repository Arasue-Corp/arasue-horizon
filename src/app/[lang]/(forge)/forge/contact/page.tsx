...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const title = (dict as any).forge.contact_page?.title || 'ForgeContactPage'
  const description = (dict as any).forge.contact_page?.subtitle || 'Arasue Horizon'
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-xl md:text-2xl opacity-70 max-w-2xl">
            {dict.forge.contact_page.subtitle || dict.forge.contact_page.content}
          </p>
        </MotionDiv>
