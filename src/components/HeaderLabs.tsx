    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-background/95 border-b border-border text-foreground">
      ...
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link href={`/${lang}/labs/contact`} className="px-4 py-2 rounded-full bg-foreground text-background text-sm font-medium active:scale-[0.97] transition-transform duration-200 ease-out flex items-center gap-1">
