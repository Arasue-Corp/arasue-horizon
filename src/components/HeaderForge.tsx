    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-background/95 border-b border-foreground/10">
      ...
      <div className="container mx-auto px-6 min-h-24 py-4 flex items-center justify-between">
        <Link href={`/${lang}/forge`} className="relative z-50 flex-shrink-0 flex items-center h-full py-2">
          <img src="/icono-forge-blanco.png" alt="Arasue Forge Icon" className="absolute top-1/2 -translate-y-1/2 left-0 h-16 md:h-24 w-auto object-contain transition-transform hover:scale-105" />
